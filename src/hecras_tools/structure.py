...
class CulvertBarrelRecord:
    """Container object for an individual culvert barrel"""
    ...
    def copy(self) -> "CulvertBarrelRecord":
...
@dataclass(slots=True)
class CulvertGroupRecord:
    """Container object for an individual structure culvert group"""
    ...
    def copy(self) -> "CulvertGroupRecord":
        """Return a deep copy of the record for defensive consumers."""
